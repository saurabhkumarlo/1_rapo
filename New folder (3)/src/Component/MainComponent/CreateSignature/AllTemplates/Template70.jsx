...
const img =
  "https://y5t6h9a6.stackpathcdn.com/81d7bb44-77e9-4d1d-bbbe-cf58ca947cac/img.png";
const Template70 = () => {
    ...
    <div style={{ margin: "auto", marginTop: "2%" }}>
      ...
      <table style={{ float: "left", marginLeft: "10px" }}>
        <tbody>
          <tr>
            <td>
              <span style={{ color: "#049cdb", fontWeight: "bold" }}>
                {" "}
                <Namecom Name={Name} />
              </span>
            </td>
        ...
        <tbody
          style={{
            borderTop: "1px solid #049cdb",
            float: "left",
            borderBottom: "1px solid #049cdb",
