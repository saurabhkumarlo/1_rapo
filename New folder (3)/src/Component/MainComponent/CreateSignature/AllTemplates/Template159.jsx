...
const img =
  "https://y5t6h9a6.stackpathcdn.com/85cc5eb5-574a-4b10-bd01-10b17a875fbf/img.png";
      ...
      <div style={{ margin: "auto", marginTop: "2%" }}>
        ...
        <table style={{ float: "left", marginLeft: "10px" }}>
          <tbody>
            <tr>
              <td>
                <span style={{ color: "#4149c3", fontWeight: "bold" }}>
                  {" "}
                  <Namecom Name={Name} />
                </span>
              </td>
          ...
          <tbody
            style={{
              borderTop: "1px solid #4149c3",
              float: "left",
              borderBottom: "1px solid #4149c3",
