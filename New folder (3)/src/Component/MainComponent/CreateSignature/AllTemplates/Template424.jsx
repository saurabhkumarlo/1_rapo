...
const img =
  "https://y5t6h9a6.stackpathcdn.com/4d75a4b0-4e6c-4f1d-8709-f93915addef4/img.png";
const Template424 = () => {
      ...
      <div style={{ margin: "auto", marginTop: "2%" }}>
        <table style={{ float: "left", marginLeft: "10px" }}>
          <tbody>
            <tr>
              <td>
                <span style={{ color: "#ff1919", fontWeight: "bold" }}>
                  {" "}
                  <Namecom Name={Name} />
                </span>
              </td>
          ...
          <tbody style={{ float: "left", padding: "11px 0" }}>
            <tr>
              <td>
