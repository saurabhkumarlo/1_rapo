      ...
      <div style={{ margin: "auto", marginTop: "2%" }}>
        <table style={{ float: "left", marginLeft: "10px" }}>
          <tbody>
            <tr>
              <td>
                <span style={{ color: "#2d77ff", fontWeight: "bold" }}>
                  {" "}
                  <Namecom Name={Name} />
                </span>
              </td>
        ...
        >
          <tbody>
            ...
            <tr>
              <td>
                <img
                  src="https://y5t6h9a6.stackpathcdn.com/a0eaf591-8559-4b09-8a0b-57b0e1c8b7ae/img.png"
                  style={{}}
                />
              </td>
            </tr>
